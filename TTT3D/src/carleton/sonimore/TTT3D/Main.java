...
//      TTT3DMove a = new TTT3DMove(1,2,3,'X');
      ...
      System.out.print("Row: " + printMove.row + " Column: " + printMove.column + " Level: " + printMove.level);
      System.out.print("Row: " + printMove2.row + " Column: " + printMove2.column + " Level: " + printMove2.level);
